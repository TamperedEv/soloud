...
MAKEFILE = console.make

ifeq ($(config),debug)
  OBJDIR              = debug/Debug/console
  TARGETDIR           = ../../bin
...
ifeq ($(config),release)
  OBJDIR              = release/Release/console
  TARGETDIR           = ../../bin
  TARGET              = $(TARGETDIR)/console
  DEFINES            += -DNDEBUG
  INCLUDES           += -I"../../include"
...
$(OBJDIR)/demos/console/main.o: ../../demos/console/main.cpp $(GCH) $(MAKEFILE) | $(OBJDIR)/demos/console
	@echo $(notdir $<)
